...
Siderska (2025) is a university lesson that teaches students to build basic software robots in UiPath Studio. It defines RPA as software robots that copy human actions in digital systems (Siderska 2025, p. 6). It lists the tasks with the highest potential for robots, such as moving data between systems and reading PDFs and emails (Siderska 2025, p. 10).

**Why I chose it:**

I selected this because I needed to know what RPA is before I could judge its risks. The lesson made one difference clear. RPA follows fixed rules, while AI learns from data (Siderska 2025, p. 14). Before this I used the two words as if they meant the same thing. Now I understand that a bot copies a process exactly, flaws included, which is why processes must be standardised before automation (Siderska 2025, p. 17). This is where Portfolio 2 ended: a process nobody understands should not be automated (Sinur, Misiak & Biernatowski 2025, p. 18). It is teaching material rather than research, so I used it for definitions only.

![Figure 1: The RPA and AI comparison in the lesson](images/fig1.png)

*Figure 1: The lesson's comparison of RPA and AI. Source: Siderska (2025, p. 14)*
...
Miao et al. (2026) propose the Cybercrime Prevention for Business Processes (CP4BP) model. It adds criminology to BPM so processes can be re-engineered to give offenders fewer opportunities (Miao et al. 2026, p. 10). Its workflow has four stages: identify, analyse, re-design and test (Miao et al. 2026, p. 11). The authors apply it to two real cases, third-party patch management and payroll fraud (Miao et al. 2026, p. 12).

**Why I chose it:**

I included this because it moves security out of IT and into process design. In the patch case, the process itself created a predictable delay that attackers could use (Miao et al. 2026, p. 12). Before this I thought cybersecurity meant firewalls and passwords. Now I read a process model looking for the delay or missing check an offender could use. This is the same habit I built in Portfolio 2 with the Anderson Inc. case, where I looked for the gateway where a control should sit and does not (Bradford, Bucy & Lee 2025, p. 141). The authors even describe my invoice example: fake emails in accounts payable workflows that trick staff into paying fraudsters (Miao et al. 2026, p. 12). A bot copying that process would pay without question. As peer-reviewed research, it is my strongest source.

![Figure 3: The CP4BP model from Miao et al.](images/fig3.png)

*Figure 3: The CP4BP model, showing the four-stage re-engineering workflow. Source: Miao et al. (2026, p. 11)*
